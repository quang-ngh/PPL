...
class LexerSuite(unittest.TestCase):
    ...
    def test_identifier1(self):
        self.assertTrue(TestLexer.test("1_234_","1234,_,<EOF>",101))
    def test_identifier2(self):
        self.assertTrue(TestLexer.test("{1,3}","{,1,,,3,},<EOF>",102))
    def test_identifier3(self):
        self.assertTrue(TestLexer.test("1.123_123e+10","1.123,_123e,+,10,<EOF>",103))
    ...
    def test_string1(self):
        self.assertTrue(TestLexer.test("\"abc\" 0 \"12ab\\fc0.1\"","abc,0,12ab\\fc0.1,<EOF>",113))
    def test_string4(self):
        self.assertTrue(TestLexer.test("\"abc\" 0 \"12ab\\fc0.1\"","abc,0,12ab\\fc0.1,<EOF>",114))
    def test_string5(self):
        self.assertTrue(TestLexer.test("\"0.1anccv\" 0.mne \"12\\\\3\"","0.1anccv,0.,mne,12\\\\3,<EOF>",115))
    def test_string6(self):
        self.assertTrue(TestLexer.test("abc \"abc1!!@#$$%^i\\n\" 12yz","abc,abc1!!@#$$%^i\\n,12,yz,<EOF>",116))
    def test_string7(self):
        self.assertTrue(TestLexer.test("\"!h$5FBi6\"_q\"!SZR,H}\"sIfpw","!h$5FBi6,_q,!SZR,H},sIfpw,<EOF>",117))
    def test_string8(self):
        self.assertTrue(TestLexer.test("4\"&J^1a_.\" QGn\"?67Sp\"/*,*/6Asz\"Yx](\"","4,&J^1a_.,QGn,?67Sp,6,Asz,Yx](,<EOF>",118))
    def test_string9(self):
        self.assertTrue(TestLexer.test("0f1_\"^VLR@\\\\OusM;\"uGM+jE","0,f1_,^VLR@\\\\OusM;,uGM,+,jE,<EOF>",119))
    def test_string10(self):
        self.assertTrue(TestLexer.test("\"(IFq+lq(\"IhK6we/*.*/GdvS/*(*/","(IFq+lq(,IhK6we,GdvS,<EOF>",120))

    #Operator test
    def test_operator1(self):
        self.assertTrue(TestLexer.test("ddsls<l>02>=d1s<=123","ddsls,<,l,>,0,2,>=,d1s,<=,123,<EOF>",121))
    def test_operator2(self):
        self.assertTrue(TestLexer.test("dlsd+1ds-*dmdsa/<>mdks","dlsd,+,1,ds,-,*,dmdsa,/,<,>,mdks,<EOF>",122))
    def test_operator3(self):
        self.assertTrue(TestLexer.test("lsddl<>=1<>=112>=<=d1","lsddl,<,>=,1,<,>=,112,>=,<=,d1,<EOF>",123))
    def test_operator4(self):
        self.assertTrue(TestLexer.test("13ek3<9e=9eend<>=Edasdndm<=>erE","13,ek3,<,9,e,=,9,eend,<,>=,Edasdndm,<=,>,erE,<EOF>",124))
    def test_operator5(self):
        self.assertTrue(TestLexer.test("djeiwjd1A<=>12>=<=d","djeiwjd1A,<=,>,12,>=,<=,d,<EOF>",125))
    def test_operator6(self):
        self.assertTrue(TestLexer.test("<-mod>=not+mod+and+not","<,-,mod,>=,not,+,mod,+,and,+,not,<EOF>",126))
    def test_operator7(self):
        self.assertTrue(TestLexer.test("*and<=>mod</<=","*,and,<=,>,mod,<,/,<=,<EOF>",127))
    def test_operator8(self):
        self.assertTrue(TestLexer.test("=or<=<><>=-<=>","=,or,<=,<,>,<,>=,-,<=,>,<EOF>",128))
    def test_operator9(self):
        self.assertTrue(TestLexer.test("not<>=and>=mod<=-and","not,<,>=,and,>=,mod,<=,-,and,<EOF>",129))
    def test_operator10(self):
        self.assertTrue(TestLexer.test("mod<=<===mod/<=<","mod,<=,<=,==,mod,/,<=,<,<EOF>",130))

    def test_random1(self):
        self.assertTrue(TestLexer.test("\"He is \\b a man", "Unclosed String: He is \\b a man", 131))
    def test_random2(self):
        self.assertTrue(TestLexer.test(""" 2+3 andthen 6 ""","2,+,3,andthen,6,<EOF>",132))
    def test_random3(self):
        self.assertTrue(TestLexer.test(""" \"abcd  /*dsf*/""","Unclosed String: abcd  /*dsf*/",133))
    def test_random4(self):
        self.assertTrue(TestLexer.test(""" \"abcd ""","Unclosed String: abcd ",134))
    def test_random5(self):
        self.assertTrue(TestLexer.test(""" \"t efg""","Unclosed String: t efg",135))
    def test_random6(self):
        self.assertTrue(TestLexer.test(""" /* /*abcd /*abcd*/^eftg */""","Error Token ^",136))
    def test_random7(self):
        self.assertTrue(TestLexer.test(""" "t\t x efg""","Unclosed String: t	 x efg",137))
    def test_random8(self):
        self.assertTrue(TestLexer.test(""" "t \ /*abcd*/\\x efg""","Illegal Escape In String: t \ ",138))
    def test_random9(self):
        self.assertTrue(TestLexer.test(""" "t x e""","Unclosed String: t x e",139))
    def test_random10(self):
        self.assertTrue(TestLexer.test(""" /*/*abcd*/*/""","*,/,<EOF>",140))
    ...
    def test_illegal_escape9(self):
        self.assertTrue(TestLexer.test("+1.1 \"ba\\qm\f\"","+,1.1,Illegal Escape In String: ba\\q",149))
    ...
    def test_unclose_String4(self):
        self.assertTrue(TestLexer.test("\"acms!,lds \" \"abc\" 123\"abc","acms!,lds ,abc,123,Unclosed String: abc",154))
    ...
    def test_unclose_String9(self):
        self.assertTrue(TestLexer.test("\"Nk8U;\"rA\"@Y3*\"oV\"bh1","Nk8U;,rA,@Y3*,oV,Unclosed String: bh1",159))
    ...
    def test_integer_real1(self):
        self.assertTrue(TestLexer.test("1.2 1. 1e2 1.2E-2 1.2e-2 1E2 9.0 12e8 0.33E-3 128e-42",
        "1.2,1.,1e2,1.2E-2,1.2e-2,1E2,9.0,12e8,0.33E-3,128e-42,<EOF>",161))
    ...
    def test_integer_real4(self):
        self.assertTrue(TestLexer.test("2.11E2 1.11 2.33 1.e12 1E-15","2.11E2,1.11,2.33,1.e12,1E-15,<EOF>",164))
    ...
    def test_integer_real6(self):
        self.assertTrue(TestLexer.test("e-12.1 11.e11 12.12 2. 11e11 2.1e-3","e,-,12.1,11.e11,12.12,2.,11e11,2.1e-3,<EOF>",166))
    ...
    def test_comment2(self):
        self.assertTrue(TestLexer.test("/*12.e0} -101*/ 11.1e2","11.1e2,<EOF>",169))
    def test_comment3(self):
        self.assertTrue(TestLexer.test(" //1.abc","<EOF>",170))
    def test_comment4(self):
        self.assertTrue(TestLexer.test("(*1.e0 - 101* /**/ //22.12\n","(,*,1.e0,-,101,*,<EOF>",171))
    ...
    def test_error_char4(self):
        self.assertTrue(TestLexer.test("(C*.=22Pta!0=&o","(,C,*,.,=,22,Pta,!,0,=,Error Token &",182))
    ...
    def test_keyword1(self):
        self.assertTrue(TestLexer.test("01anc mds For c brEaK 21mc continuE km","0,1,anc,mds,For,c,brEaK,21,mc,continuE,km,<EOF>",189))
    def test_keyword2(self):
        self.assertTrue(TestLexer.test("tO doWnto Do if thEn elSE return1","tO,doWnto,Do,if,thEn,elSE,return1,<EOF>",190))
    def test_keyword3(self):
        self.assertTrue(TestLexer.test("reTuRn whILe beGin eND function o","reTuRn,whILe,beGin,eND,function,o,<EOF>",191))
    def test_keyword4(self):
        self.assertTrue(TestLexer.test("pROCEDURE TRUe 1.12VAR45 ARRay OF 12REAL","pROCEDURE,TRUe,1.12,VAR45,ARRay,OF,12,REAL,<EOF>",192))
    def test_keyword5(self):
        self.assertTrue(TestLexer.test("BOOLEAN int 1.12INTEGER sTRIng not 12and","BOOLEAN,int,1.12,INTEGER,sTRIng,not,12,and,<EOF>",193))
    def test_keyword6(self):
        self.assertTrue(TestLexer.test("oR diVModNTEGER Mod nottrEu","oR,diVModNTEGER,Mod,nottrEu,<EOF>",194))
    def test_keyword7(self):
        self.assertTrue(TestLexer.test("if then else diMod 12String true ds false","if,then,else,diMod,12,String,true,ds,false,<EOF>",195))
    def test_keyword8(self):
        self.assertTrue(TestLexer.test("anD then elsediMod doWnTO21trueds false","anD,then,elsediMod,doWnTO21trueds,false,<EOF>",196))
    def test_keyword9(self):
        self.assertTrue(TestLexer.test("anD thadenelsediMod doWnTO1truedsfalse BOOLEAN float 1.12INTEGER sTRIng noT d15s0and",
        "anD,thadenelsediMod,doWnTO1truedsfalse,BOOLEAN,float,1.12,INTEGER,sTRIng,noT,d15s0and,<EOF>",197))
    def test_keyword10(self):
        self.assertTrue(TestLexer.test("12while int 1.12 INTEGER oR 12function","12,while,int,1.12,INTEGER,oR,12,function,<EOF>",198))

    def test_string_unclosed5(self):
        self.assertTrue(TestLexer.test("\"abc\t\"","abc	,<EOF>",199))
    def test_string_demo1(self):
        self.assertTrue(TestLexer.test(""" "He asked me: \"Where is John 0_123\"" """, "He asked me: ,Where,is,John,0,_123,,<EOF>", 200))